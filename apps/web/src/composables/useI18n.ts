...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'loading.label': '正在轻轻点亮这一页…',
    'nav.about': '关于我',
    'nav.essays': '随笔',
    'nav.home': '首页',
    'nav.messages': '留言板',
    'nav.photos': '照片墙',
    'terminal.commandNotFound': 'bash: {cmd}: command not found',
    'terminal.enterHint': '点击屏幕进入 · 或输入 clear',
  ...
  en: {
    ...
    'loading.label': 'Waking up this page…',
    'nav.about': 'About',
    'nav.essays': 'Essays',
    'nav.home': 'Home',
    ...
    'nav.thoughts': 'Notes',
    'terminal.commandNotFound': 'bash: {cmd}: command not found',
    'terminal.enterHint': 'Click to enter, or type clear',
  ...
  ja: {
    ...
    'nav.thoughts': 'つぶやき',
    'terminal.commandNotFound': 'bash: {cmd}: command not found',
    'terminal.enterHint': 'クリックで入る、または clear を入力',
