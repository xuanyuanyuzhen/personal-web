...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'home.liked': '已喜欢本站',
    'home.mascot': '看板娘占位',
    'home.quoteLabel': '今日拾语',
    'home.clockLabel': '当前时间',
    'home.carouselLabel': '随笔轮播',
    'home.latestEssay': '最新随笔',
    'home.photoWall': '照片墙',
    'home.recentMessages': '最新留言',
    'home.empty': '内容还在路上…',
    'home.statusLabel': '站点状态',
    'home.statusOnline': '一切安好',
    'home.statusDays': '已安静记录 {days} 天',
    'mascot.label': '看板娘',
    ...
    'music.pause': '暂停',
    'music.play': '播放',
    'music.playFailed': '播放失败，可能是浏览器拦截了自动播放，请再点一次播放键。',
    'music.previous': '上一首',
    'music.random': '随机',
    'music.single': '单曲',
  ...
  en: {
    ...
    'home.quoteLabel': 'Words to keep',
    'home.clockLabel': 'Current time',
    'home.carouselLabel': 'Essay carousel',
    'home.latestEssay': 'Latest essay',
    'home.photoWall': 'Photo wall',
    'home.recentMessages': 'Recent messages',
    'home.empty': 'Content on the way…',
    'home.statusLabel': 'Site status',
    'home.statusOnline': 'All is calm',
    'home.statusDays': 'Quietly recording for {days} days',
    'mascot.label': 'Mascot',
    ...
    'music.pause': 'Pause',
    'music.play': 'Play',
    'music.playFailed': 'Playback failed. Your browser may have blocked autoplay — tap play again.',
  ...
  ja: {
    ...
    'home.quoteLabel': '今日のことば',
    'home.clockLabel': '現在時刻',
    'home.carouselLabel': '随筆スライド',
    'home.latestEssay': '最新の随筆',
    'home.photoWall': 'フォトウォール',
    'home.recentMessages': '新着メッセージ',
    'home.empty': 'コンテンツ準備中…',
    'home.statusLabel': 'サイトステータス',
    'home.statusOnline': '平常運転',
    'home.statusDays': '静かに記録して {days} 日',
    'mascot.label': '看板娘',
    ...
    'music.play': '再生',
    'music.playFailed':
      '再生できませんでした。自動再生がブロックされた可能性があります。もう一度お試しください。',
    'music.previous': '前へ',
    'music.random': 'ランダム',
    'music.single': '単曲',
