...
function thumbnailTransitionName(photo: PublicPhoto) {
  return transitionPhotoId.value === photo.id && previewPhoto.value === null ? 'photo-preview' : 'none';
}

function previewTransitionName(photo: PublicPhoto | null) {
  return photo && transitionPhotoId.value === photo.id && previewPhoto.value !== null ? 'photo-preview' : 'none';
}
